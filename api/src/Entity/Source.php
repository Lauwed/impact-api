...
#[ApiResource(
    normalizationContext: ['groups' => ['source:read', 'identityField:read', 'personSchool:read', 'personJob:read', 'personSocialStatus:read', 'personRelative:read', 'achievement:read']],
...
class Source
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['source:read', 'identityField:read', 'personSchool:read', 'personJob:read', 'personSocialStatus:read', 'personRelative:read', 'achievement:read'])]
    private ?int $id = null;
