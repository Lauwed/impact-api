...
/**
 * @extends ServiceEntityRepository<PersonPicture>
 */
class PersonPictureRepository extends ServiceEntityRepository
{
    ...
    //    public function findOneBySomeField($value): ?PersonPicture
    //    {
    //        return $this->createQueryBuilder('p')
    //            ->andWhere('p.exampleField = :val')
    //            ->setParameter('val', $value)
